 ...
 */
public class RSSLoaderLove extends AsyncTaskLoader<String[][]> {//非同期処理を行うクラス。非同期で動作するクラス。必要なのはsuperにコンテキストを渡すコンストラクタと非同期処理を行うloadInBackground()。
    String[] target;
    String[][] array2dim;
    String src;
    int titlecount =0;
    ...
    int timecount =0;
    private String[][] data;
    public RSSLoaderLove(Context context) {
        super(context);
    }
...
*/
            ...
            Fragment9 s9 = new Fragment9();
            String s = s9.RSS_FEED_URL;
