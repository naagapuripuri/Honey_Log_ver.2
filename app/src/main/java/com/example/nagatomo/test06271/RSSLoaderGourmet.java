 ...
 */
public class RSSLoaderGourmet extends AsyncTaskLoader<String[][]> {//非同期処理を行うクラス。非同期で動作するクラス。必要なのはsuperにコンテキストを渡すコンストラクタと非同期処理を行うloadInBackground()。
    String[] target;
    String[][] array2dim;
    String src;
    int titlecount =0;
    ...
    int timecount =0;
    private String[][] data;
    public RSSLoaderGourmet(Context context) {
        super(context);
    }
...
*/
            ...
            Fragment8 s8 = new Fragment8();
            String s = s8.RSS_FEED_URL;
